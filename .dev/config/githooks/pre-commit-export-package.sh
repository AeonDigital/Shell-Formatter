...
# EXPORT_PACKAGE_SHELL_FORMATTER
EXPORT_PACKAGE_REGISTER+=("Shell-Formatter")

declare -gA EXPORT_PACKAGE_SHELL_FORMATTER=()
EXPORT_PACKAGE_SHELL_FORMATTER["project_url"]="https://github.com/AeonDigital/Shell-Formatter"
EXPORT_PACKAGE_SHELL_FORMATTER["project_name"]="Shell-Formatter"
EXPORT_PACKAGE_SHELL_FORMATTER["project_license_type"]="MIT"
EXPORT_PACKAGE_SHELL_FORMATTER["project_license_url"]="LICENSE"
EXPORT_PACKAGE_SHELL_FORMATTER["project_root_path"]="${GIT_HOOK_PROJECT_ROOT_PATH}"
EXPORT_PACKAGE_SHELL_FORMATTER["source_dir_path"]="src/formatter"
EXPORT_PACKAGE_SHELL_FORMATTER["assets_dir_path"]="src/shared"
EXPORT_PACKAGE_SHELL_FORMATTER["export_file_path"]="package.sh"
EXPORT_PACKAGE_SHELL_FORMATTER["use_autoexec"]="src/formatter/main_autoexec.sh"